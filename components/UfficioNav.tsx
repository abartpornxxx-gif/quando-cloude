...
const MACRO: MacroEntry[] = [
  ...
  },
  {
    ...
    dot: 'bg-emerald-400',
    prefixes: ['/ufficio/clienti', '/ufficio/fornitori', '/ufficio/operai'],
    items: [
      { label: 'Clienti', href: '/ufficio/clienti', desc: 'Anagrafica' },
      { label: 'Fornitori', href: '/ufficio/fornitori', desc: 'Anagrafica' },
      { label: 'Operai', href: '/ufficio/operai', desc: 'Anagrafica' },
    ],
  },
  {
    label: 'Magazzino',
    ...
    items: [
      { label: 'Ordini', href: '/ufficio/ordini', desc: 'A fornitori' },
    ],
  },
  {
    label: 'Finanza',
    ...
    dot: 'bg-indigo-500',
    prefixes: ['/ufficio/fatture', '/ufficio/fatture-passive', '/ufficio/saldi-pendenti', '/ufficio/scadenzario'],
    items: [
...
export function UfficioNav() {
  ...
  return (
    <div className="border-t border-teal-600/80 bg-teal-800">
        ...
        <div className="hidden md:flex items-stretch">
          ...
          <Link
            ...
            className={`shrink-0 flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium border-b-2 transition-colors ${
              isDashboard
                ? 'border-white text-white bg-teal-900/20'
                : 'border-transparent text-teal-100 hover:text-white hover:bg-teal-700/20'
            }`}
          >
            <LayoutDashboard size={13} className={isDashboard ? 'text-white' : 'text-teal-200'} />
            Dashboard
          </Link>
          ...
          <div className="flex items-center gap-2">
            {(() => {
              ...
              if (activeMacro) {
                ...
                return (
                  <>
                    <div className="flex h-6 w-6 items-center justify-center rounded-md bg-teal-900/30 text-teal-200">
                      <Icon size={13} />
                    </div>
      ...
      {menuAperto && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute inset-y-0 right-0 w-72 max-w-[85vw] bg-white shadow-2xl flex flex-col overflow-hidden">
            {/* Header pannello */}
            <div className="flex items-center justify-between px-4 py-3.5 bg-teal-900 shrink-0">
                ...
                return (
                  <div key={macro.label} className="px-3 mb-3">
                    ...
                    <div className="flex items-center gap-2 px-3 mb-1.5">
                      ...
                      <p className={`text-[11px] font-bold uppercase tracking-wider ${macroActive ? 'text-teal-600' : 'text-gray-400'}`}>
                        {macro.label}
                      </p>
                    </div>
                    {/* Items */}
