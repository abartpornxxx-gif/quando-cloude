...
const MACRO: MacroEntry[] = [
  {
    ...
    items: [
      ...
      { label: 'Pianifica domani', href: '/impresa/pianificazione/domani', desc: 'Assegna operai per domani' },
      { label: 'Pianifica giorno', href: '/impresa/pianificazione/giorno', desc: 'Vista touch mobile' },
