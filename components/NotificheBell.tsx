...
export function NotificheBell({ count, href, colore = 'blue' }: Props) {
  const ringCls = {
    blue: 'hover:bg-blue-600 text-blue-100',
    emerald: 'hover:bg-emerald-600 text-emerald-100',
    yellow: 'hover:bg-yellow-500 text-yellow-100',
    violet: 'hover:bg-violet-600 text-violet-100',
  }[colore]
