...
// Switch from pooler port 6543 to session port 5432 to allow raw connections/testing
...
async function main() {
  ...
  // Dynamically import prisma so that DATABASE_URL is set before initialization
